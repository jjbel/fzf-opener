...
fzf_opts = 'fzf --color=fg:#d0d0d0,fg+:#d0d0d0,bg:#101011,bg+:#262626   --color=hl:#5f87af,hl+:#22fff0,info:#afaf87,marker:#87ff00 --color=prompt:#d7005f,spinner:#af5fff,pointer:#af5fff,header:#87afaf --color=border:#262626,label:#aeaeae,query:#d9d9d9   --preview-window="border-rounded" --prompt="> " --marker=">"'
